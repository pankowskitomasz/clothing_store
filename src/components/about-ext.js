        ...
        return(        
            <Container fluid className={"about-ext p-0 minh-50vh d-flex align-items-center py-3 "+this.props.classExt}>
                <Row className="mx-auto text-center w-100">
                    ...
                    <Col xs={12} md={6} className="text-center text-md-start p-4 d-flex align-items-center order-1 order-md-2 text-dark-pink">
                        <div>
                            <h2 className="mb-3 mt-5 text-white text-shadow">
                                Why Shop With Us
                            </h2>
                            <p className="lead">
