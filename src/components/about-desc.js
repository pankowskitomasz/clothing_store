...
class AboutDesc extends Component{
    render(){
        ...
        return(        
            <Container fluid className={"about-desc p-0 minh-50vh d-flex align-items-center py-3 border-bottom border-dark-pink "+this.props.classExt}>
                <Row className="mx-auto text-center w-100 pt-5 pb-2">
                    <Col xs={12} md={6} className="text-center text-md-start p-4 d-flex align-items-center text-dark-pink">
                        <div>
                            <h2 className="mb-3 mt-5 fw-bold text-shadow text-white">
                                The Begining
                            </h2>
                            <p className="lead">
                                As an independent brand focused on representing best quality, we design 
