            ...
            <Container fluid className={"contact-form align-items-center p-0 py-5 d-flex minh-50vh " + this.props.classExt}>
                <Row className="mx-auto text-center w-100">
                    <Col xs={10} md={6} className="mx-auto p-0 d-flex align-items-center">
                        <Card className="mx-auto bg-light-pink opacity-8 border-dark-pink shadow">
                            <Card.Header className="text-white bg-dark-pink text-start border-dark-pink">
                                Message error!
                            </Card.Header>
                            <Card.Body className="text-center text-dark-pink p-5">
